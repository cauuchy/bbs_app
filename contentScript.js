...
function showLength(id, str) {
	...
	if (linecount.length > 30) {
		linemes = "<font color=\"red\" style=\"font-size:85%\">※行数オーバーです。（MAX30行\/現在" + linecount.length + "行）</font>";
	} else {
		linemes = "";
	}
...
function showLength_mln(id, str) {
	...
	if (linecount.length > 20) {
		linemes = "<font color=\"red\" style=\"font-size:85%\">※行数オーバーです。（MAX20行\/現在" + linecount.length + "行）</font>";
	} else {
		linemes = "";
	}
